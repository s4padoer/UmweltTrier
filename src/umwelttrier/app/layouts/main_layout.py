...
from app.figures.figure_wetterdienst import get_timeseries_temperatur
from app.figures.figure_luftqualitaet import get_luftqualitaet_plot, get_alternative_luftqualitaet_plot
from app.figures.figure_moselwasser import update_moseltemperatur_und_fisch
